...
Waiting1v1Manager& Waiting1v1Manager::getInstance()
{
    static Waiting1v1Manager instance;
    return instance;
}
...
std::pair<GeneralResponseErrors, bool> Waiting1v1Manager::didPlayerFoundMatch(const LoggedUser& loggedUser) const
{
    std::lock_guard<std::mutex> lock(this->m_waitingListMutex);
